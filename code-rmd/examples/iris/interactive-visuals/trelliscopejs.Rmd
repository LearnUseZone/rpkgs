...
These scatter plots are created also by using `trelliscopejs::facet_trelliscope()` which has advantages but also few disadvantages.
...
More about trelliscopejs is [here](https://github.com/hafen/trelliscopejs) and in [README](https://github.com/LearnUseZone/rpkgs/tree/master/code/workflowrsubdirs) file.
