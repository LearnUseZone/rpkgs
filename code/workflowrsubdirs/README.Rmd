...
- Version 0.0.0.0300 contains possibility to use inline R code in YAML header if .Rmd file is saved in a subdirectory
  - Previously, one of generate_rmd behavior was:
    rmarkdown::yaml_front_matter(relPath) with relPath = (e.g.) ./code-Rmd/<file_name.Rmd> and YAML header part (in this .Rmd file)
    date:    "`r format (Sys.time(), format='%Y-%m-%d %H:%M:%S %z')`"
    returned following as one item of a list
    ...
    which firstly create a new .Rmd file which is used in yaml::as.yaml(rmarkdown::yaml_front_matter(<file_path_to_output_file.Rmd>)),
