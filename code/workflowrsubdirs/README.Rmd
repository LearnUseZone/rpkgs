...
- If other than `workflowr` project is originally opened using its .Rproj file then
  ...
  - More precisely, if a project\'s working directory consists of all following directories
    ...
    ```
    generates an associated .html file (together with a relevant docs or public directory with directory
    `site_libs` and file `.nojekyll`).
